    ...
    <div class="pt-20 pb-20">
      <div class="container mx-auto overflow-hidden">
        ...
        <div class="flex lg:flex-row flex-col  items-center justify-between gap-10 ">
          ...
          >
            <span class="pl-3 pr-4 rounded-full text-primary bg-assent text-xl font-bold mb-4">
              1
            </span>
        ...
        <hr />
        <div class="flex lg:flex-row flex-col-reverse items-center justify-between gap-10 mt-10">
          <motion.div
            variants={fadeIn("right", 0.2)}
            initial="hidden"
            whileInView="show"
        ...
        <hr />
        <div class="flex lg:flex-row flex-col  items-center justify-between gap-20 mt-10">
          <motion.div
            variants={fadeIn("right", 0.2)}
            initial="hidden"
            whileInView="show"
        ...
        <hr />
        <div class="flex lg:flex-row flex-col-reverse  items-center justify-between gap-20 mt-10">
          <motion.div
            variants={fadeIn("right", 0.2)}
            initial="hidden"
            whileInView="show"
